...
בשלב הראשון תוכיחו שאם \`x\` שייך לעולם \`U\`, \`A\` היא קבוצה של איברים
מתוך \`U\`, ו-\`x ∈ A\`, אז \`x ∈ A\`.

למטה תוכלו לראות את \`U\`, \`x\` ו-\`A\`
...
תוכלו לשנות את שדה הטקסט בתוך הבלוק שיתאים למזהה ההנחה שאתם צריכים.
